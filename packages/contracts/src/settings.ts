...
export const ProjectSpace = Schema.Struct({
  id: TrimmedNonEmptyString,
  name: TrimmedNonEmptyString,
  projectKeys: Schema.Array(TrimmedNonEmptyString),
  threadKeys: Schema.optionalKey(Schema.Array(TrimmedNonEmptyString)),
...
export const ClientSettingsSchema = Schema.Struct({
  ...
  projectSpaces: Schema.Array(ProjectSpace).pipe(Schema.withDecodingDefault(Effect.succeed([]))),
...
export const ClientSettingsPatch = Schema.Struct({
  ...
  projectSpaces: Schema.optionalKey(Schema.Array(ProjectSpace)),
