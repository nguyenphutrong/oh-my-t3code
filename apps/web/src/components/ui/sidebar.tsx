  ...
  return (
    <SidebarInstanceContext value={instanceContextValue}>
      ...
      >
        ...
        >
          <div
            className="flex h-full w-full flex-col bg-sidebar surface-grain group-data-[variant=floating]:overflow-hidden group-data-[variant=inset]:overflow-hidden group-data-[variant=floating]:rounded-[20px] group-data-[variant=inset]:rounded-[20px] group-data-[variant=floating]:border group-data-[variant=inset]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=inset]:border-sidebar-border group-data-[variant=floating]:shadow-sm/5 group-data-[variant=inset]:shadow-sm/5"
            data-sidebar="sidebar"
