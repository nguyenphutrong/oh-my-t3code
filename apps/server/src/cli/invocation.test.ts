...
it("formats package runner commands from their cache entry paths", () => {
  for (const [entryPath, expected] of [
    [
      "/home/theo/.npm/_npx/abc123/node_modules/oh-my-t3code/dist/bin.mjs",
      "npx oh-my-t3code serve",
    ],
    [
    ...
    [
      "/home/theo/.cache/pnpm/dlx/abc/node_modules/oh-my-t3code/dist/bin.mjs",
      "pnpm dlx oh-my-t3code serve",
    ],
    [
    ...
    ["/home/theo/.bun/install/cache/oh-my-t3code@0.0.31/dist/bin.mjs", "bunx oh-my-t3code serve"],
    [
      "/tmp/bunx-1000-oh-my-t3code@latest/node_modules/oh-my-t3code/dist/bin.mjs",
      "bunx oh-my-t3code serve",
    ],
    [
...
it("re-suggests the prerelease channel only for prerelease builds", () => {
  for (const [version, expected] of [
    ["0.0.31-nightly.20260729", "npx oh-my-t3code@nightly serve"],
    ["0.0.31-preview.20260729.1", "npx oh-my-t3code@preview serve"],
    ["0.0.31-foo-preview.20260729.1", "npx oh-my-t3code serve"],
    ["0.0.31", "npx oh-my-t3code serve"],
  ] as const) {
    assert.equal(
      formatCliCommand({
        subcommand: "serve",
...
it("formats serve suggestions to match the launching command", () => {
  assert.equal(
    ...
    "npx oh-my-t3code@nightly serve",
  );
  assert.equal(
    formatCliCommand({
      subcommand: "serve",
