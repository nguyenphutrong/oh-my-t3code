...
export class DesktopEnvironment extends Context.Service<
  DesktopEnvironment,
  {
    ...
    // Built web client the packaged renderer is served from over oh-my-t3code://app.
...
const APP_BASE_NAME = "Oh My T3Code";
...
const make = Effect.fn("desktop.environment.make")(function* (
  ...
  const userDataDirName = isDevelopment ? "oh-my-t3code-dev" : "oh-my-t3code";
  const legacyUserDataDirName = isDevelopment ? "Oh My T3Code (Dev)" : "Oh My T3Code (Alpha)";
