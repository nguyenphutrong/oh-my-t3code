...
const DESKTOP_APP_ID = "app.bytrong.ohmyt3code";
...
export function resolveDesktopProductName(version: string): string {
  return resolveDesktopUpdateChannel(version) === "nightly"
    ? "Oh My T3Code (Nightly)"
    : (desktopPackageJson.productName ?? "Oh My T3Code");
}
...
export const createBuildConfig = Effect.fn("createBuildConfig")(function* (
  ...
  const buildConfig: Record<string, unknown> = {
    ...
    artifactName: "Oh-My-T3Code-${version}-${arch}.${ext}",
    ...
    buildConfig.mac = {
      ...
      extendInfo: {
        NSScreenCaptureUsageDescription:
          "Oh My T3Code captures the active window when you use the window capture shortcut.",
      },
      protocols: [
        {
          name: "Oh My T3Code",
          schemes: ["oh-my-t3code", "oh-my-t3code-dev"],
        },
      ],
